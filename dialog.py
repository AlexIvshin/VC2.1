...
actions_dict: dict = {
    ...
    'search': (
        ...
        'вики', 'википедия', 'википедии', 'что', 'такое', 'короткий', 'быстрый'),
    'sys_down': (
